...
class ConverterCheckStyleTest extends PHPUnit
{
    public function testToInternalPhan()
    {
        ...
        isSame(implode("\n", [
            ...
            '        <failure type="PhanPluginCanUseReturnType" message="Can use \JBZoo\ToolboxCI\JUnit\TestSuiteElement as a return type of addTestSuite">',
            'Can use \JBZoo\ToolboxCI\JUnit\TestSuiteElement as a return type of addTestSuite',
            ...
            '        <failure type="PhanPluginSuspiciousParamPositionInternal" message="Suspicious order for argument name - This is getting passed to parameter #1 (string $name) of \JBZoo\ToolboxCI\JUnit\TestCaseElement::setAttribute(string $name, string $value)">',
            'Suspicious order for argument name - This is getting passed to parameter #1 (string $name) of \JBZoo\ToolboxCI\JUnit\TestCaseElement::setAttribute(string $name, string $value)',
            ...
            '        <failure type="PhanPluginSuspiciousParamPositionInternal" message="Suspicious order for argument name - This is getting passed to parameter #1 (string $name) of \JBZoo\ToolboxCI\JUnit\TestSuiteElement::setAttribute(string $name, string $value)">',
            'Suspicious order for argument name - This is getting passed to parameter #1 (string $name) of \JBZoo\ToolboxCI\JUnit\TestSuiteElement::setAttribute(string $name, string $value)',
            'Rule     : PhanPluginSuspiciousParamPositionInternal',
    ...
    public function testToInternalPhpStan()
    {
        ...
        isSame(implode("\n", [
            ...
            'Method JBZoo\ToolboxCI\JUnit\TestCaseElement::setName() has no return typehint specified.',
            'File Path: src/JUnit/TestCaseElement.php:34',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            ...
            '        <failure type="ERROR" message="Method JBZoo\ToolboxCI\JUnit\TestCaseElement::setClassname() has no return typehint specified.">',
            'Method JBZoo\ToolboxCI\JUnit\TestCaseElement::setClassname() has no return typehint specified.',
            'File Path: src/JUnit/TestCaseElement.php:42',
            'Severity : error',
            '</failure>',
            '      </testcase>',
            ...
            '        <failure type="ERROR" message="Method JBZoo\ToolboxCI\JUnit\TestCaseElement::setTime() has no return typehint specified.">',
            'Method JBZoo\ToolboxCI\JUnit\TestCaseElement::setTime() has no return typehint specified.',
